...
- Update to `kyverno-policy-operator` (app) version 0.0.5.
...
- Update to `exception-recommender` (app) version 0.0.3.
...
[Unreleased]: https://github.com/giantswarm/security-bundle/compare/v0.18.3...HEAD
[0.18.3]: https://github.com/giantswarm/security-bundle/compare/v0.18.2...v0.18.3
